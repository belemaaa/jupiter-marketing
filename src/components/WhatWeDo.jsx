...
const WhatWeDo = () => {
  return (
    <div className='flex flex-col mt-16 relative mx-0 px-0 overflow-hidden'>
        <div className='flex items-center justify-center'>
            <p className='text-orange-700 text-4xl font-bold mb-4 border-b border-b-gray-700 pb-3'>WHAT WE DO</p>
        </div>
